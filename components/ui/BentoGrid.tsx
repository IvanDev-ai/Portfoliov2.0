...
export const BentoGridItem = ({
  ...
  const rightLists = ["Pytorch", "Pandas", "Tensorflow"];
              ...
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                {leftLists.map((item, i) => (
                  <span
                    ...
                    lg:opacity-100 rounded-lg text-center bg-[#222222]"
                  >
                    {item}
                  </span>
                ))}
                <span className="lg:py-4 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#222222]"></span>
              </div>
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                <span className="lg:py-4 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#222222]"></span>
