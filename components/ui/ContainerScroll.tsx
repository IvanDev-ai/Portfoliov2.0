...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-full mb-40 md:mb-0 flex items-center justify-center relative"
      ref={containerRef}
    >
      <div
...
export const Footer = ({ FooterComponent }: { FooterComponent: string | React.ReactNode; }) => {
  return (
    <motion.div
      className="flex flex-col lg:flex-row items-start lg:items-center mt-[5rem] mx-[2rem] lg:mx-[20rem]"
